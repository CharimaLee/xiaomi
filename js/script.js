var goodsList = [{
    id: 1234564876,
    imgUrl: 'img/1.png',
    goodsInfo: '鍙峰湴鍧楀仴韬埧鍥炲鐨勭鎶€绀鸿寖鎴峰揩閫熷潥瀹炵殑鐪嬩簡鐪嬪ぇ瀹跺彂蹇€掍簡寰堣垂鍔茬殑寮€濮嬫斁鍋�',
    goodsParams: '鍥涘搴﹀悗浠樻鐨勯吀杈ｇ矇',
    price: 199,
    goodsCount: 1,
...
$.each(goodsList, function(i, item) {
    var goodsHtml = '<div class="goods-item">' +
        ...
        '<div class="col-md-1 car-goods-info goods-price"><span>锟�</span><span class="single-price">' + item.price + '</span></div>' +
        ...
        '</div>' +
        '</div>' +
        '<div class="col-md-1 car-goods-info goods-money-count"><span>锟�</span><span class="single-total">' + item.singleGoodsMoney + '</span></div>' +
        '<div class="col-md-2 car-goods-info goods-operate">' +
        '<button type="button" class="btn btn-danger item-delete">鍒犻櫎</button>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
